""""Tests for individual CSS color name parsing."""
from rich_color_ext import _extended_parse

def test_parse_color_aliceblue():
    """Test to parse the CSS color `aliceblue`"""
...
def test_parse_color_antiquewhite():
    """Test to parse the CSS color `antiquewhite`"""
...
def test_parse_color_aqua():
    """Test to parse the CSS color `aqua`"""
...
def test_parse_color_aquamarine():
    """Test to parse the CSS color `aquamarine`"""
...
def test_parse_color_azure():
    """Test to parse the CSS color `azure`"""
...
def test_parse_color_beige():
    """Test to parse the CSS color `beige`"""
...
def test_parse_color_bisque():
    """Test to parse the CSS color `bisque`"""
...
def test_parse_color_black():
    """Test to parse the CSS color `black`"""
...
def test_parse_color_blanchedalmond():
    """Test to parse the CSS color `blanchedalmond`"""
...
def test_parse_color_blue():
    """Test to parse the CSS color `blue`"""
...
def test_parse_color_blueviolet():
    """Test to parse the CSS color `blueviolet`"""
...
def test_parse_color_brown():
    """Test to parse the CSS color `brown`"""
...
def test_parse_color_burlywood():
    """Test to parse the CSS color `burlywood`"""
...
def test_parse_color_cadetblue():
    """Test to parse the CSS color `cadetblue`"""
...
def test_parse_color_chartreuse():
    """Test to parse the CSS color `chartreuse`"""
...
def test_parse_color_chocolate():
    """Test to parse the CSS color `chocolate`"""
...
def test_parse_color_coral():
    """Test to parse the CSS color `coral`"""
...
def test_parse_color_cornflowerblue():
    """Test to parse the CSS color `cornflowerblue`"""
...
def test_parse_color_cornsilk():
    """Test to parse the CSS color `cornsilk`"""
...
def test_parse_color_crimson():
    """Test to parse the CSS color `crimson`"""
...
def test_parse_color_cyan():
    """Test to parse the CSS color `cyan`"""
...
def test_parse_color_darkblue():
    """Test to parse the CSS color `darkblue`"""
...
def test_parse_color_darkcyan():
    """Test to parse the CSS color `darkcyan`"""
...
def test_parse_color_darkgoldenrod():
    """Test to parse the CSS color `darkgoldenrod`"""
...
def test_parse_color_darkgray():
    """Test to parse the CSS color `darkgray`"""
...
def test_parse_color_darkgreen():
    """Test to parse the CSS color `darkgreen`"""
...
def test_parse_color_darkgrey():
    """Test to parse the CSS color `darkgrey`"""
...
def test_parse_color_darkkhaki():
    """Test to parse the CSS color `darkkhaki`"""
...
def test_parse_color_darkmagenta():
    """Test to parse the CSS color `darkmagenta`"""
...
def test_parse_color_darkolivegreen():
    """Test to parse the CSS color `darkolivegreen`"""
...
def test_parse_color_darkorange():
    """Test to parse the CSS color `darkorange`"""
...
def test_parse_color_darkorchid():
    """Test to parse the CSS color `darkorchid`"""
...
def test_parse_color_darkred():
    """Test to parse the CSS color `darkred`"""
...
def test_parse_color_darksalmon():
    """Test to parse the CSS color `darksalmon`"""
...
def test_parse_color_darkseagreen():
    """Test to parse the CSS color `darkseagreen`"""
...
def test_parse_color_darkslateblue():
    """Test to parse the CSS color `darkslateblue`"""
...
def test_parse_color_darkslategray():
    """Test to parse the CSS color `darkslategray`"""
...
def test_parse_color_darkslategrey():
    """Test to parse the CSS color `darkslategrey`"""
...
def test_parse_color_darkturquoise():
    """Test to parse the CSS color `darkturquoise`"""
...
def test_parse_color_darkviolet():
    """Test to parse the CSS color `darkviolet`"""
...
def test_parse_color_deeppink():
    """Test to parse the CSS color `deeppink`"""
...
def test_parse_color_deepskyblue():
    """Test to parse the CSS color `deepskyblue`"""
...
def test_parse_color_dimgray():
    """Test to parse the CSS color `dimgray`"""
...
def test_parse_color_dimgrey():
    """Test to parse the CSS color `dimgrey`"""
...
def test_parse_color_dodgerblue():
    """Test to parse the CSS color `dodgerblue`"""
...
def test_parse_color_firebrick():
    """Test to parse the CSS color `firebrick`"""
...
def test_parse_color_floralwhite():
    """Test to parse the CSS color `floralwhite`"""
...
def test_parse_color_forestgreen():
    """Test to parse the CSS color `forestgreen`"""
...
def test_parse_color_fuchsia():
    """Test to parse the CSS color `fuchsia`"""
...
def test_parse_color_gainsboro():
    """Test to parse the CSS color `gainsboro`"""
...
def test_parse_color_ghostwhite():
    """Test to parse the CSS color `ghostwhite`"""
...
def test_parse_color_gold():
    """Test to parse the CSS color `gold`"""
...
def test_parse_color_goldenrod():
    """Test to parse the CSS color `goldenrod`"""
...
def test_parse_color_gray():
    """Test to parse the CSS color `gray`"""
...
def test_parse_color_green():
    """Test to parse the CSS color `green`"""
...
def test_parse_color_greenyellow():
    """Test to parse the CSS color `greenyellow`"""
...
def test_parse_color_grey():
    """Test to parse the CSS color `grey`"""
...
def test_parse_color_honeydew():
    """Test to parse the CSS color `honeydew`"""
...
def test_parse_color_hotpink():
    """Test to parse the CSS color `hotpink`"""
...
def test_parse_color_indianred():
    """Test to parse the CSS color `indianred`"""
...
def test_parse_color_indigo():
    """Test to parse the CSS color `indigo`"""
...
def test_parse_color_ivory():
    """Test to parse the CSS color `ivory`"""
...
def test_parse_color_khaki():
    """Test to parse the CSS color `khaki`"""
...
def test_parse_color_lavender():
    """Test to parse the CSS color `lavender`"""
...
def test_parse_color_lavenderblush():
    """Test to parse the CSS color `lavenderblush`"""
...
def test_parse_color_lawngreen():
    """Test to parse the CSS color `lawngreen`"""
...
def test_parse_color_lemonchiffon():
    """Test to parse the CSS color `lemonchiffon`"""
...
def test_parse_color_lightblue():
    """Test to parse the CSS color `lightblue`"""
...
def test_parse_color_lightcoral():
    """Test to parse the CSS color `lightcoral`"""
...
def test_parse_color_lightcyan():
    """Test to parse the CSS color `lightcyan`"""
...
def test_parse_color_lightgoldenrodyellow():
    """Test to parse the CSS color `lightgoldenrodyellow`"""
...
def test_parse_color_lightgray():
    """Test to parse the CSS color `lightgray`"""
...
def test_parse_color_lightgreen():
    """Test to parse the CSS color `lightgreen`"""
...
def test_parse_color_lightgrey():
    """Test to parse the CSS color `lightgrey`"""
...
def test_parse_color_lightpink():
    """Test to parse the CSS color `lightpink`"""
...
def test_parse_color_lightsalmon():
    """Test to parse the CSS color `lightsalmon`"""
...
def test_parse_color_lightseagreen():
    """Test to parse the CSS color `lightseagreen`"""
...
def test_parse_color_lightskyblue():
    """Test to parse the CSS color `lightskyblue`"""
...
def test_parse_color_lightslategray():
    """Test to parse the CSS color `lightslategray`"""
...
def test_parse_color_lightslategrey():
    """Test to parse the CSS color `lightslategrey`"""
...
def test_parse_color_lightsteelblue():
    """Test to parse the CSS color `lightsteelblue`"""
...
def test_parse_color_lightyellow():
    """Test to parse the CSS color `lightyellow`"""
...
def test_parse_color_lime():
    """Test to parse the CSS color `lime`"""
...
def test_parse_color_limegreen():
    """Test to parse the CSS color `limegreen`"""
...
def test_parse_color_linen():
    """Test to parse the CSS color `linen`"""
...
def test_parse_color_magenta():
    """Test to parse the CSS color `magenta`"""
...
def test_parse_color_maroon():
    """Test to parse the CSS color `maroon`"""
...
def test_parse_color_mediumaquamarine():
    """Test to parse the CSS color `mediumaquamarine`"""
...
def test_parse_color_mediumblue():
    """Test to parse the CSS color `mediumblue`"""
...
def test_parse_color_mediumorchid():
    """Test to parse the CSS color `mediumorchid`"""
...
def test_parse_color_mediumpurple():
    """Test to parse the CSS color `mediumpurple`"""
...
def test_parse_color_mediumseagreen():
    """Test to parse the CSS color `mediumseagreen`"""
...
def test_parse_color_mediumslateblue():
    """Test to parse the CSS color `mediumslateblue`"""
...
def test_parse_color_mediumspringgreen():
    """Test to parse the CSS color `mediumspringgreen`"""
...
def test_parse_color_mediumturquoise():
    """Test to parse the CSS color `mediumturquoise`"""
...
def test_parse_color_mediumvioletred():
    """Test to parse the CSS color `mediumvioletred`"""
...
def test_parse_color_midnightblue():
    """Test to parse the CSS color `midnightblue`"""
...
def test_parse_color_mintcream():
    """Test to parse the CSS color `mintcream`"""
...
def test_parse_color_mistyrose():
    """Test to parse the CSS color `mistyrose`"""
...
def test_parse_color_moccasin():
    """Test to parse the CSS color `moccasin`"""
...
def test_parse_color_navajowhite():
    """Test to parse the CSS color `navajowhite`"""
...
def test_parse_color_navy():
    """Test to parse the CSS color `navy`"""
...
def test_parse_color_oldlace():
    """Test to parse the CSS color `oldlace`"""
...
def test_parse_color_olive():
    """Test to parse the CSS color `olive`"""
...
def test_parse_color_olivedrab():
    """Test to parse the CSS color `olivedrab`"""
...
def test_parse_color_orange():
    """Test to parse the CSS color `orange`"""
...
def test_parse_color_orangered():
    """Test to parse the CSS color `orangered`"""
...
def test_parse_color_orchid():
    """Test to parse the CSS color `orchid`"""
...
def test_parse_color_palegoldenrod():
    """Test to parse the CSS color `palegoldenrod`"""
...
def test_parse_color_palegreen():
    """Test to parse the CSS color `palegreen`"""
...
def test_parse_color_paleturquoise():
    """Test to parse the CSS color `paleturquoise`"""
...
def test_parse_color_palevioletred():
    """Test to parse the CSS color `palevioletred`"""
...
def test_parse_color_papayawhip():
    """Test to parse the CSS color `papayawhip`"""
...
def test_parse_color_peachpuff():
    """Test to parse the CSS color `peachpuff`"""
...
def test_parse_color_peru():
    """Test to parse the CSS color `peru`"""
...
def test_parse_color_pink():
    """Test to parse the CSS color `pink`"""
...
def test_parse_color_plum():
    """Test to parse the CSS color `plum`"""
...
def test_parse_color_powderblue():
    """Test to parse the CSS color `powderblue`"""
...
def test_parse_color_purple():
    """Test to parse the CSS color `purple`"""
...
def test_parse_color_rebeccapurple():
    """Test to parse the CSS color `rebeccapurple`"""
...
def test_parse_color_red():
    """Test to parse the CSS color `red`"""
...
def test_parse_color_rosybrown():
    """Test to parse the CSS color `rosybrown`"""
...
def test_parse_color_royalblue():
    """Test to parse the CSS color `royalblue`"""
...
def test_parse_color_saddlebrown():
    """Test to parse the CSS color `saddlebrown`"""
...
def test_parse_color_salmon():
    """Test to parse the CSS color `salmon`"""
...
def test_parse_color_sandybrown():
    """Test to parse the CSS color `sandybrown`"""
...
def test_parse_color_seagreen():
    """Test to parse the CSS color `seagreen`"""
...
def test_parse_color_seashell():
    """Test to parse the CSS color `seashell`"""
...
def test_parse_color_sienna():
    """Test to parse the CSS color `sienna`"""
...
def test_parse_color_silver():
    """Test to parse the CSS color `silver`"""
...
def test_parse_color_skyblue():
    """Test to parse the CSS color `skyblue`"""
...
def test_parse_color_slateblue():
    """Test to parse the CSS color `slateblue`"""
...
def test_parse_color_slategray():
    """Test to parse the CSS color `slategray`"""
...
def test_parse_color_slategrey():
    """Test to parse the CSS color `slategrey`"""
...
def test_parse_color_snow():
    """Test to parse the CSS color `snow`"""
...
def test_parse_color_springgreen():
    """Test to parse the CSS color `springgreen`"""
...
def test_parse_color_steelblue():
    """Test to parse the CSS color `steelblue`"""
...
def test_parse_color_tan():
    """Test to parse the CSS color `tan`"""
...
def test_parse_color_teal():
    """Test to parse the CSS color `teal`"""
...
def test_parse_color_thistle():
    """Test to parse the CSS color `thistle`"""
...
def test_parse_color_tomato():
    """Test to parse the CSS color `tomato`"""
...
def test_parse_color_turquoise():
    """Test to parse the CSS color `turquoise`"""
...
def test_parse_color_violet():
    """Test to parse the CSS color `violet`"""
...
def test_parse_color_wheat():
    """Test to parse the CSS color `wheat`"""
...
def test_parse_color_white():
    """Test to parse the CSS color `white`"""
...
def test_parse_color_whitesmoke():
    """Test to parse the CSS color `whitesmoke`"""
...
def test_parse_color_yellow():
    """Test to parse the CSS color `yellow`"""
...
def test_parse_color_yellowgreen():
    """Test to parse the CSS color `yellowgreen`"""
